    ...
    wexinPay() {
      ...
      if (typeof WeixinJSBridge == "undefined") {
        if (document.addEventListener) {
          ...
          document.attachEvent("WeixinJSBridgeReady", this.onBridgeReady(this.wechatData));
          document.attachEvent("onWeixinJSBridgeReady", this.onBridgeReady(this.wechatData));
        }
      } else {
        this.onBridgeReady(this.wechatData);
      }
